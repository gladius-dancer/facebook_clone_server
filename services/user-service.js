...
class UserService{
    async register(firstName, lastName, email, password, tel_number){
        ...
        const user = await UserModel.create({firstName, lastName, email, password: hashpassword, tel_number, activationLink});
